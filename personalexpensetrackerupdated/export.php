...
$expenseTransactions = array_filter($transactions, function($transaction) {
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-chart-pie"></i> Expense Report</h1>
            <p>Analyze your spending patterns and categories</p>
        </div>
        ...
        <div class="navigation">
            ...
            <a href="expense_report.php" class="btn btn-danger">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="summary-amount">रु<?php echo number_format($totalExpenses, 2); ?></div>
                <div class="summary-label">Total Expenses</div>
            </div>
            <div class="summary-card">
                <i class="fas fa-receipt"></i>
                <div class="summary-amount"><?php echo count($expenseTransactions); ?></div>
                <div class="summary-label">Expense Transactions</div>
            </div>
        </div>
        ...
        <div class="transactions-list">
            <div class="transactions-header">
                <h2><i class="fas fa-list"></i> Expense Transactions</h2>
            </div>
            <div id="transactions-container">
                <?php if (empty($expenseTransactions)): ?>
                    <div class="empty-state">
                        ...
                        <p>Add your first expense transaction to get started</p>
                    </div>
                <?php else: ?>
                    <?php foreach ($expenseTransactions as $transactionItem): ?>
